...
@section("breadcrumbs")
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard.supplier-orders.index') }}">supplier order</a>
            </li>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <input type="hidden" value="{{ $total+= $ingredient->pivot->price*$ingredient->pivot->quantity }}"></input>
                        </tr>
                        @endforeach
                        <tr>
