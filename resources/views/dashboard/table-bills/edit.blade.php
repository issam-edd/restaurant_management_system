...
@section('breadcrumbs')
    <h2 class="content-header-title float-left mb-0">Edit Table Bill</h2>
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{ route('dashboard.Supplier-Orders.index') }}">Table Bill list</a>
            </li>
            <li class="breadcrumb-item">
                <a href="#">Home</a>
            </li>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Edit Table Bill</h4>
            </div>
            <div class="card-body">
                @include('partials._errors')
                <form
                    class="form"
                    action="{{ route('dashboard.table-bills.update', $tableBill->id) }}"
                    method="POST"
