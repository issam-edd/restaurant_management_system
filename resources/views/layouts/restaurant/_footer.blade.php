<footer class="padding-top-40 padding-bottom-40">
    <div class="fo-shapes">
        ...
        <span class="fs-2 item-bounce"><img src={{asset('assets/images/shapes/25.png')}} alt=""></span>
        <span class="fs-3 item-bounce"><img src={{asset('assets/images/shapes/26.png')}} alt=""></span>
        <span class="fs-4 item-bounce"><img src={{asset('assets/images/shapes/27.png')}} alt=""></span>
        <span class="fs-5 item-animateTwo"><img src={{asset('assets/images/shapes/3.png')}} alt=""></span>
    ...
    <div class="footer-bottom padding-top-22 padding-bottom-30">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12 margin-bottom-20">
                    <div class="widget">
                        <h6>address</h6>
