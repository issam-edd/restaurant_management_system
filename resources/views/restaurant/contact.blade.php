...
@section('content')
    ...
    <section class="about-area about-area2 writeto-us padding-top-120 padding-bottom-60">
        <div class="form-shapes">
            <span class="fs1 item-animateOne"><img src="{{ asset('restaurant-assets/images/shapes/1.png') }}" alt=""></span>
            <span class="fs2 item-bounce"><img src="{{ asset('restaurant-assets/images/shapes/12.png') }}" alt=""></span>
            <span class="fs3"><img src="{{ asset('restaurant-assets/images/shapes/13.png') }}" alt=""></span>
            <span class="fs4 item-bounce"><img src="{{ asset('restaurant-assets/images/shapes/26.png') }}" alt=""></span>
        </div>
        <div class="container">
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-5 col-5 d-flex align-items-stretch ">
                                <div class="about-gallery-5 text-center">
                                    <img src="{{ asset('restaurant-assets/images/gallery/5.jpg') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-12 wow fadeInUp">
                    ...
                    >
                            ...
                            <textarea id="message" name="message" placeholder="write your text"></textarea>
    ...
    <div class="info-area padding-bottom-120">
        <div class="info-shapes">
            <span class="info-s-1"><img src="{{ asset('restaurant-assets/images/shapes/7.png') }}" alt=""></span>
            <span class="info-s-2"><img src="{{ asset('restaurant-assets/images/img/32.png') }}" alt=""></span>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 wow fadeInUp" data-wow-delay=".2s">
                    <div
                        ...
                        <div class="info-img">
                            <img src="{{ asset('restaurant-assets/images/icons/c1.png') }}" alt="">
                        </div>
                        <div class="info-content text-center text-lg-left">
                            <h5>Phone Us 24/7</h5>
                            <p>+212 6 00 00 09 00</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 wow fadeInUp" data-wow-delay=".4s">
                    <div
                        class="single-info d-flex flex-sm-row flex-md-column flex-lg-row  justify-content-around align-items-center">
                        <div class="info-img">
                            <img src="{{ asset('restaurant-assets/images/icons/c2.png') }}" alt="">
                        </div>
                        <div class="info-content text-center text-lg-left">
                            <h5>Get Direction</h5>
                            <p>320 8th Boulevard Allal El Fassi,
                                Marrakech</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 wow fadeInUp" data-wow-delay=".6s">
                    <div
                        class="single-info d-flex flex-sm-row flex-md-column flex-lg-row  justify-content-around align-items-center">
                        <div class="info-img">
                            <img src="{{ asset('restaurant-assets/images/icons/c3.png') }}" alt="">
                        </div>
                        <div class="info-content text-center text-lg-left">
                            <h5>Opening Hours</h5>
                            <p><span>monday-friday: 8am - 12am</span>
                                <br><span>saturday: 9am - 1am</span>
                            </p>
                        </div>
                    </div>
                </div>
...
<!--
    <div class="map-area padding-bottom-120 wow fadeInUp">
        <div class="map-shapes">
            <div class="ms-1"><img src="{{ asset('restaurant-assets/images/shapes/16.png') }}" alt=""></div>
        </div>
        <div class="container">
            <iframe
