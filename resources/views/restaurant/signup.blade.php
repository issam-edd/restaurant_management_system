            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 wow fadeInUp">
                    ...
                    >
                        {{ csrf_field() }}
                        {{ method_field('post') }}
                            <input type="text" id="first_name"class="form-control" placeholder="first_name" name="first_name" value="first_name" >
                            <input type="text" id="last_name"class="form-control" placeholder="last_name" name="last_name" value="last_name" >
                            <input type="email" id="email"  class="form-control" placeholder="email"name="email" value="email" >
                            <input type="text" id="address"  class="form-control" placeholder="address"name="address" value="address" >
                            <input type="text" id="phone"  class="form-control" placeholder="phone"name="phone" value="phone" >
                            <input type="password" id="password"class="form-control" placeholder="password" name="password"value="password" >
                            <input type="password" id="confirm"class="form-control" placeholder="confirm password" >@if ('password'!='confirm password')
