...
@section('content')
    <div class="food-area-wrapper">
        <div class="pshapes">
            <span class="ps-1 item-bounce"><img src="{{ asset('restaurant-assets/images/img/32.png') }}" alt=""></span>
            <span class="ps-2 item-animateTwo"><img src="{{ asset('restaurant-assets/images/shapes/12.png') }}" alt=""></span>
            <span class="ps3 item-bounce"><img src="{{ asset('restaurant-assets/images/shapes/13.png') }}" alt=""></span>
            <span class="ps-4"><img src="{{ asset('restaurant-assets/images/shapes/14.png') }}" alt=""></span>
            <span class="ps-5"><img src="{{ asset('restaurant-assets/images/img/6.png') }}" alt=""></span>
            <span class="ps-6"><img src="{{ asset('restaurant-assets/images/shapes/16.png') }}" alt=""></span>
            <span class="ps-7 item-animateOne"><img src="{{ asset('restaurant-assets/images/img/6.png') }}" alt=""></span>
        </div>
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <div class="sidebar-widget-1 wow fadeInUp">
                        ...
                        <div class="sidebar-widget d-flex">
                            <div class="dish-img">
                                <a href="single-food.html"><img src="{{ asset('restaurant-assets/images/menu-item/pd6.png') }}" alt=""></a>
                            </div>
                            <div class="dish-content">
                                <h6> <a href="single-food.html">Chicken Fry
                                        Recipe
                                    </a></h6>
                                <span class="price">25.00 DH</span>
                                <span>
                                    <a class="cart-select" href="{{route('restaurant.shopping-card')}}"><i
                        ...
                        <div class="sidebar-widget d-flex">
                            <div class="dish-img">
                                <a href="single-food.html"><img src="{{ asset('restaurant-assets/images/menu-item/pd4.png') }}" alt=""></a>
                            </div>
                            <div class="dish-content">
                                <h6> <a href="single-food.html">Chicken Soup
                                        Rejala
                                    </a></h6>
                                <span class="price">20.00 DH</span>
                                <span>
                                    <a class="cart-select" href="{{route('restaurant.shopping-card')}}"><i
                                            class="fas fa-shopping-basket"></i></a>
                                </span>
                        ...
                        <div class="sidebar-widget d-flex">
                            <div class="dish-img">
                                <a href="single-food.html"> <img src="{{ asset('restaurant-assets/images/menu-item/pd7.png') }}" alt=""></a>
                            </div>
                            <div class="dish-content">
                                <h6> <a href="single-food.html">The Best Black
                                        Frame
                                    </a></h6>
                                <span class="price">80.00 DH</span>
                                <span>
                                    <a class="cart-select" href="{{route('restaurant.shopping-card')}}"><i
                                            class="fas fa-shopping-basket"></i></a>
                                </span>
                        ...
                        <div class="sidebar-widget d-flex">
                            <div class="dish-img">
                                <a href="single-food.html"><img src="{{ asset('restaurant-assets/images/menu-item/pd8.png') }}" alt=""></a>
                            </div>
                            <div class="dish-content">
                                <h6> <a href="single-food.html">The Best Black
                                        Frame
                        ...
                        <div class="filter-sidebar margin-top-30">
                            ...
                            <div>
                                <div class="margin-top-30">
                                    <span class="textbold"> Price:</span>
                                    <input type="text" id="amount" readonly class="textbold">
                    ...
                    <div class="sidebar-widget-3 wow fadeInUp">
                        ...
                        <div class="sidebar-widget d-flex align-items-center">
                            <div class="dish-img">
                                <a href="single-food.html"> <img src="{{ asset('restaurant-assets/images/menu-item/fm1.png') }}" alt=""></a>
                            </div>
                        ...
                        <div class="sidebar-widget d-flex align-items-center">
                            <div class="dish-img">
                                <a href="single-food.html"> <img src="{{ asset('restaurant-assets/images/menu-item/fm2.png') }}" alt=""></a>
                            </div>
                            <div class="dish-content d-flex justify-content-between">
                                <h6> <a href="single-food.html">Chicken fry
                                    </a></h6>
                        ...
                        <div class="sidebar-widget d-flex align-items-center">
                            <div class="dish-img">
                                <a href="single-food.html"> <img src="{{ asset('restaurant-assets/images/menu-item/fm3.png') }}" alt=""></a>
                            </div>
                            <div class="dish-content d-flex justify-content-between">
                        ...
                        <div class="sidebar-widget d-flex align-items-center">
                            <div class="dish-img">
                                <a href="single-food.html"><img src="{{ asset('restaurant-assets/images/menu-item/fm4.png') }}" alt=""></a>
                            </div>
                    ...
                    <div class="sidebar-widget-4 wow fadeInUp">
                        <div class="gallery-img-4">
                            ...
                            <span class="gshape-1"><img src="{{ asset('restaurant-assets/images/shapes/35.png') }}" alt=""></span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="container">
                            <nav
                                ...
                                <div class="nav" id="nav-tab-1" role="tablist">
                                    <a class="nav-link active" id="food1-tab" data-toggle="tab" href="#food1" role="tab"
                                       aria-controls="food1" aria-selected="true"><span><i
                            ...
                            <div class="tab-content" id="nav-tabContent-1">
                                ...
                                <div class="tab-pane fade show active" id="food1" role="tabpanel"
                                     aria-labelledby="food1">
                                    <div class="row">
                                        <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                                            <div class="single-dishes">
                                                <div class="dish-img">
                                                    <img src="{{ asset('restaurant-assets/images/menu-item/pd1.png') }}" style="width: inherit;"
                                                         alt="">
                                                </div>
                                                <div class="dish-content">
                                                    ...
                                                    <span class="price">price :15.00 DH</span>
                                                ...
                                                <div class="cart-opt">
                                                    ...
                                                    <span>
                                                        <a href="{{route('restaurant.shopping-card')}}"><i
                                                                class="fas fa-shopping-basket"></i></a>
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                                            <div class="single-dishes">
                                                <div class="dish-img">
                                                    <img src="{{ asset('restaurant-assets/images/menu-item/pd2.png') }}" style="width: inherit;"
                                                         alt="">
                                                </div>
                                                <div class="dish-content">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                                            <div class="single-dishes">
                                                <div class="dish-img">
                                                    <img src="{{ asset('restaurant-assets/images/menu-item/pd3.png') }}" style="width: inherit;"
                                                         alt="">
                                                </div>
                                                <div class="dish-content">
                                                    ...
                                                    <p>It is a long established fact that a reader BBQ food Chicken.</p>
                                                    <span class="price badge-color">price :15.00 DH</span>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                                            <div class="single-dishes">
                                                <div class="dish-img">
                                                    <img src="{{ asset('restaurant-assets/images/menu-item/pd4.png') }}" style="width: inherit;"
                                                         alt="">
                                                </div>
                                                <div class="dish-content">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                                            <div class="single-dishes">
                                                <div class="dish-img">
                                                    <img src="{{ asset('restaurant-assets/images/menu-item/pd5.png') }}" style="width: inherit;"
                                                         alt="">
                                                </div>
                                                <div class="dish-content">
                                                    <h5><a href="single-food.html"> Garlic Burger
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                                            <div class="single-dishes">
                                                <div class="dish-img">
                                                    <img src="{{ asset('restaurant-assets/images/menu-item/pd6.png') }}" style="width: inherit;"
                                                         alt="">
                                                </div>
                                                <div class="dish-content">
                                                    <h5> <a href="single-food.html">Vegetable Pizza
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                                            <div class="single-dishes">
                                                <div class="dish-img">
                                                    <img src="{{ asset('restaurant-assets/images/menu-item/pd7.png') }}" style="width: inherit;"
                                                         alt="">
                                                </div>
                                                <div class="dish-content">
                                                    <h5><a href="single-food.html">Chicken Fry
                                                    ...
                                                    <p>It is a long established fact that a reader BBQ food Chicken.</p>
                                                    <span class="badge-color price">price :15.00 DH</span>
                                                    <span class="rating"> <i class="fas fa-star"></i> 5star</span>
                                                </div>
                                                <span class="badge"></span>
                                                <div class="cart-opt">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                                            <div class="single-dishes">
                                                <div class="dish-img">
                                                    <img src="{{ asset('restaurant-assets/images/menu-item/pd8.png') }}" style="width: inherit;"
                                                         alt="">
                                                </div>
                                                <div class="dish-content">
                                                    <h5><a href="single-food.html">Chickpea Soup
                                ...
                                <!-- food 2 -->
                                <div class="tab-pane fade" id="food2" role="tabpanel" aria-labelledby="food2">
                                    <div class="row">
